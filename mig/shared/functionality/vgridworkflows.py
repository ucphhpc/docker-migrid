...
'''})
    ...
    '''})
        ...
        output_objects.append({'object_type': 'html_form', 'text': """
        <p>
        On this page you can register a Workflow Pattern and subsequent attached Recipes.
        ...
        The <b>input</b> defines the system path from which the workflow should monitor </br>
        for incoming events that should trigger the execution of an attached Recipe. </br>
        It is possible to define multiple inputs. </br>
        </br>
        The <b>output</b> defines the system path from which the workflow should save </br>
        the file outputs generated by the attached Recipes. </br>
        </br>
        The <b>type-filter</b> defines the type of files in the defined <b>input</b> that should trigger </br>
        the execution on a particular Recipe. Valid recipe file definitions includes: </br> </br>
            - <b>jupyter notebook (ipynb)</b> </br> 

        </br>
        The <b>recipes</b> defines the program/source code that should be executed on the triggering </br>
        of a valid event. The recipes can be define in a Jupyter Notebook as shown here .... </br>
        or by .... </br>
        </p>"""})
        ...
        <form enctype='multipart/form-data' method='%(form_method)s'
            ...
            Optional Recipe(s): <input name='recipes' type='file' multiple /></br>
