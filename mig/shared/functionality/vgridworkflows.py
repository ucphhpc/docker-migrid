...
'''})
    ...
    '''})
        ...
        Valid recipe file definitions includes: </br> </br>
            - <b>jupyter notebook (ipynb)</b> </br>

        </br>
        The <b>recipes</b> defines the program/source code
         that should be executed on the triggering </br>
        of a valid event. Multiple recipes can be listed 
        and should be seperated with a semicolon. <br> The 
        recipes can be defined in a Jupyter Notebook as 
        shown here .... </br>
        or by .... </br>
        </p>"""})
