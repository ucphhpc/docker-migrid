...
def main(client_id, user_arguments_dict):
    ...
    logger.debug("DELETE ME - user_arguments_dict: " + str(user_arguments_dict))
    ...
    logger.debug("DELETE ME - external_dict: " + str(external_dict))

    mrsl = fields_to_mrsl(configuration, user_arguments_dict, external_dict)

    logger.debug("DELETE ME - mrsl: " + str(mrsl))
...
CSRF-filtered POST requests to prevent unintended updates'''
    ...
    logger.debug(
        "DELETE ME - real_path: " + str(real_path))
    logger.debug(
        "DELETE ME - client_id: " + str(client_id))
