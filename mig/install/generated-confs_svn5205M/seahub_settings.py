...
SECRET_KEY = "mq/j0pprnxzc3/zxsqdsupsdryyrkwgmzydgvxkrrha="
...
# Address tweaks
# Use proxied URL
FILE_SERVER_ROOT = 'https://sid.migrid.test/seafhttp'
...
EMAIL_HOST_USER = 'mig@migrid.test'    # username and domain
...
# 0|.../seafile-server-latest/seahub/media > ln -s /home/mig/mig/images/skin/erda-user-friendly/seafile custom
